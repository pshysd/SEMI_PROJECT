					...
					<div id="notice-list-admin">
						...
						<thead>
							<tr style="background-color: #4e73df; color: white; height: 50px;">
								...
								<th width="200px" style="font-size: 18px;">작성자</th>
								<th width="700x" style="font-size: 18px;">전시명</th>
								<th width="150px" style="font-size: 18px;">내용</th>
								<th width="100px" style="font-size: 18px;">평점</th>
