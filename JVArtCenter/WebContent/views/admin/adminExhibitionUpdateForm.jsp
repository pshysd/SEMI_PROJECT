			...
			<div id="content">
				...
				<div id="admin_contents">
					...
					<!-- content 내용 여기에 붙여넣기! -->
			          ...
			          <form id="exhibit-update-form" action="#" method="post" enctype="multipart/form-data"> 
			            ...
			            <div>
			              <table align="center">
			                ...
			                <tr>
			                  <th>제목</th>
			                  <td><input type="text" name="title" size="59" required value="<%= %>"></td> 
			                </tr>
			                <tr>
			                  <th>내용</th>
			                  <td><textarea name="content" style="resize:none;" cols="60" rows="5" ><%=  %></textarea></td>
			                </tr>
			                <tr>
			                	<th>시작일</th>
			                	<td><input type="date" name="startDate" required value="<%= %>"></td>
			                </tr>
			                <tr>
			                	<th>종료일</th>
			                	<td><input type="date" name="endDate" required value="<%= %>"></td>			                
			                </tr>
			                <tr>
			                	<th>가격</th>
			                	<td><input type="text" name="price" size="14" required value="<%= %>"></td>
			                </tr>
			                <tr>
			                	<th>작가</th>
			                	<td><input type="text" name="artist" size="59"  value="<%= %>"></td>
			                </tr>			                			                			                
			                <tr>
			                	<th>대표 이미지</th>
			                	<td><img src="<%= contextPath %>/<%= list.get(0).getFilePath() + list.get(0).getChangeName() %>"  id="titleImg" width="170" height="150"></td>
			                ...
			                <tr>
			                  ...
			                  <% if(list.get(1) != null) { %>
			                  		<td>
			                  			<img src="<%= contextPath %>/<%= list.get(1).getFilePath() + list.get(1).getChangeName() %>"  id="contentImg" width="170" height="150">
			                  			<input type="hidden" name="originFileNo1" value="<%= list.get(1).getFileNo() %>">
			                       		<input type="hidden" name="originFileName1" value="<%= list.get(1).getChangeName() %>">
			                  		</td>
			                  <% } %>
