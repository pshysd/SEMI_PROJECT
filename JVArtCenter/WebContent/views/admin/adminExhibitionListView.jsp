...
<%-- import 할 것들 --%>
<%@ page
	import="java.util.ArrayList, com.kh.exhibition.model.vo.Exhibition, com.kh.common.model.vo.PageInfo"%>
			...
			<div id="content">
				...
				<div id="admin_contents">
					...
					<div id="ex-search-form">
						<form action="<%=contextPath%>/admin_list.ex?currentPage=1"
							method="get">
					...
					<div id="ex-list-admin">
						<table align="center">
							<thead>
								<tr
									style="background-color: #4e73df; color: white; height: 50px; text-align: center;">
									<th></th>
					...
					<div id="ex-paging-admin" align="center">
						...
						%>
						<button
							onclick="location.href='<%=contextPath%>/admin_list.ex?currentPage=<%=currentPage - 1%>';"
						...
						%>
						<button
							onclick="location.href='<%=contextPath%>/admin_list.ex?currentPage=<%=p%>';"
						...
						%>
						<button
							onclick="location.href='<%=contextPath%>/admin_list.ex?currentPage=<%=currentPage + 1%>';">&gt;</button>
						<%
							}
						%>
					</div>
