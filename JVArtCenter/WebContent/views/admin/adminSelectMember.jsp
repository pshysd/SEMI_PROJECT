						...
						<table id="info">
							<thead>
								<tr style="background-color:#4e73df; color:white; height:50px;">
									...
									<th width="100px" style="text-align: center">정보수정</th>
									<th width="100px" style="text-align: center">탈퇴</th>
								  </tr>
							</thead>
							<tbody>
								<% for(Member m : list) { %>
									<tr>
										...
										<td width="100px" style="text-align: center"><a href="<%= contextPath %>/adminUpdateForm.me?mno=<%= m.getMemNo() %>">수정</a></td>
										<td width="100px" style="text-align: center"><a href="<%= contextPath %>/deletemember.admin?mno=<%= m.getMemNo() %>">삭제</a></td>
									</tr>
								<%} %>
							</tbody>	
						</table><br>
