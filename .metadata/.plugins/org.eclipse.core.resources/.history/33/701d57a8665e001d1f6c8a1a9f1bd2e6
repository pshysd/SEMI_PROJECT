		...
		<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item"
					href="<%=contextPath%>/list.ex?currentPage=1">전시 목록</a> <a
					class="collapse-item" href="<%=contextPath%>/insert.ex">전시 추가</a>
			</div>
		</div></li>
	...
	<li class="nav-item"><a class="nav-link collapsed" href=""
		...
		<div id="collapseUtilities" class="collapse"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item"
					href="<%=contextPath%>/list.mb?currentPage=1">회원 정보 조회</a>
	...
	<li class="nav-item"><a class="nav-link collapsed" href=""
		...
		<div id="collapsePages" class="collapse"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item" href="<%=contextPath%>/list.no">공지사항</a> <a
					class="collapse-item" href="<%=contextPath%>/list.ne">뉴스레터</a> <a
					class="collapse-item" href="<%=contextPath%>/list.qna">1대1문의</a> <a
					class="collapse-item" href="<%=contextPath%>/list.re?currentPage=1">리뷰</a>
			</div>
		</div></li>
