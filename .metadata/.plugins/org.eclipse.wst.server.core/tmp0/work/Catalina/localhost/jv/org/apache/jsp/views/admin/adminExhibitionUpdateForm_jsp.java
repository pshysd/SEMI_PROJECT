 ...
 * Generated at: 2022-11-08 07:17:59 UTC
...
public final class adminExhibitionUpdateForm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String contextPath = request.getContextPath(); 
	...
	ArrayList<Attachment> list = (ArrayList<Attachment>)request.getAttribute("list");
      ...
      out.write("\r\n");
      out.write("			          <div id=\"exhibit-header\">\r\n");
      out.write("			            <h2 style=\"font-size: 40px; margin-left: 20px;\">전시 관리</h2>\r\n");
      out.write("			          </div>\r\n");
      out.write("			\r\n");
      out.write("					  <br><br>\r\n");
      out.write("\r\n");
      out.write("			          <form id=\"exhibit-update-form\" action=\"#\" method=\"post\" enctype=\"multipart/form-data\"> \r\n");
      out.write("			            \r\n");
      out.write("			            <div>\r\n");
      out.write("			              <table align=\"center\">\r\n");
      out.write("			                <tr>\r\n");
      out.write("			                  <th width=\"300px\">전시장소</th>\r\n");
      out.write("			                  <td width=\"600px\" >\r\n");
      out.write("			                    <select name=\"location\" id=\"exhibit-location\">\r\n");
      out.write("			                      <option selected disabled hidden>전시관 선택</option>\r\n");
      out.write("			                      <option>J관</option>\r\n");
      out.write("			                      <option>V관</option>\r\n");
      out.write("			                      <option>A관</option>\r\n");
      out.write("			                      <option>C관</option>\r\n");
      out.write("			                    </select>\r\n");
      out.write("			                    \r\n");
      out.write("								<script>\r\n");
      out.write("			                      $(function() {\r\n");
      out.write("			                        $(\"#exhibit-update-form option\").each(function() {\r\n");
      ...
      out.write("			                <tr>\r\n");
      out.write("			                  <th>제목</th>\r\n");
      out.write("			                  <td><input type=\"text\" name=\"title\" size=\"59\" required value=\"");
      out.print( );
      out.write("\"></td> \r\n");
      out.write("			                </tr>\r\n");
      out.write("			                <tr>\r\n");
      out.write("			                  <th>내용</th>\r\n");
      out.write("			                  <td><textarea name=\"content\" style=\"resize:none;\" cols=\"60\" rows=\"5\" >");
      out.print(  );
      out.write("</textarea></td>\r\n");
      out.write("			                </tr>\r\n");
      out.write("			                <tr>\r\n");
      out.write("			                	<th>시작일</th>\r\n");
      out.write("			                	<td><input type=\"date\" name=\"startDate\" required value=\"");
      out.print( );
      out.write("\"></td>\r\n");
      out.write("			                </tr>\r\n");
      out.write("			                <tr>\r\n");
      out.write("			                	<th>종료일</th>\r\n");
      out.write("			                	<td><input type=\"date\" name=\"endDate\" required value=\"");
      out.print( );
      out.write("\"></td>			                \r\n");
      out.write("			                </tr>\r\n");
      out.write("			                <tr>\r\n");
      out.write("			                	<th>가격</th>\r\n");
      out.write("			                	<td><input type=\"text\" name=\"price\" size=\"14\" required value=\"");
      out.print( );
      out.write("\"></td>\r\n");
      out.write("			                </tr>\r\n");
      out.write("			                <tr>\r\n");
      out.write("			                	<th>작가</th>\r\n");
      out.write("			                	<td><input type=\"text\" name=\"artist\" size=\"59\"  value=\"");
      out.print( );
      out.write("\"></td>\r\n");
      out.write("			                </tr>			                			                			                \r\n");
      out.write("			                <tr>\r\n");
      ...
      out.write("\"  id=\"titleImg\" width=\"170\" height=\"150\"></td>\r\n");
      out.write("			                	<input type=\"hidden\" name=\"originFileNo0\" value=\"");
      out.print( list.get(0).getFileNo() );
      out.write("\">\r\n");
      out.write("			                    <input type=\"hidden\" name=\"originFileName0\" value=\"");
      out.print( list.get(0).getChangeName() );
      out.write("\">\r\n");
      out.write("			                </tr>\r\n");
      out.write("			                <tr>\r\n");
      out.write("			                  <th>상세 이미지</th>\r\n");
      out.write("			                  ");
 if(list.get(1) != null) { 
      out.write("\r\n");
      out.write("			                  		<td>\r\n");
      ...
      out.print( contextPath );
      out.write('/');
      out.print( list.get(1).getFilePath() + list.get(1).getChangeName() );
      out.write("\"  id=\"contentImg\" width=\"170\" height=\"150\">\r\n");
      out.write("			                  			<input type=\"hidden\" name=\"originFileNo1\" value=\"");
      out.print( list.get(1).getFileNo() );
      out.write("\">\r\n");
      out.write("			                       		<input type=\"hidden\" name=\"originFileName1\" value=\"");
      out.print( list.get(1).getChangeName() );
      out.write("\">\r\n");
      out.write("			                  		</td>\r\n");
      out.write("			                  ");
 } 
      ...
      out.write("			                <input type=\"file\" id=\"file0\" name=\"file0\" onchange=\"loadImg(this, 0);\"> \r\n");
      ...
      out.write("				        			$(\"#file0\").click();\r\n");
      out.write("				        		});\r\n");
      out.write("				        		$(\"#contentImg\").click(function() {\r\n");
      ...
      out.write("				                    		case 0 : $(\"#titleImg\").attr(\"src\", e.target.result); break;\r\n");
      ...
      out.write("				                	\r\n");
      out.write("				                	switch(num) {\r\n");
      out.write("				                    	case 0 : $(\"#titleImg\").attr(\"src\", null); break;\r\n");
      ...
      out.write("			              <button type=\"button\" class=\"btn btn-outline-primary\" onclick=\"history.back();\">목록</button>\r\n");
      out.write("			            </div>\r\n");
      out.write("			          </form>\r\n");
      out.write("				</div>\r\n");
      out.write("\r\n");
