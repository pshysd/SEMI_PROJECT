			...
			<div id="content">
				...
				<div id="admin_contents">
					...
					<!-- content 내용 여기에 붙여넣기! -->
			          ...
			          <form id="exhibit-enroll-form" action="#" method="post" enctype="multipart/form-data"> 
			            ...
			            <div>
			              <table align="center">
			                ...
			                <tr>
			                	<th>작가</th>
			                	<td><input type="text" name="artist" size="59"></td>
			                </tr>			                			                			                
			                <tr>
			                	<th>대표 이미지</th>
			                	<td><img id="titleImg" width="170" height="150"></td>
			                </tr>
			                <tr>
			                  <th>상세 이미지</th>
			                  <td><img id="contentImg" width="170" height="150"></td>
			                </tr>
			              </table>
			            </div>
