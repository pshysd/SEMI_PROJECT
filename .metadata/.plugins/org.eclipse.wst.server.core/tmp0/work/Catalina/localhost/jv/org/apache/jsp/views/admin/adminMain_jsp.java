 ...
 * Generated at: 2022-11-03 11:17:18 UTC
...
public final class adminMain_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/admin/../admin/adminScript.html", Long.valueOf(1667468742925L));
    _jspx_dependants.put("/views/admin/adminSidebar.jsp", Long.valueOf(1667473298891L));
 ...
 String contextPath = request.getContextPath(); 
      ...
      out.write("					href=\"");
      out.print(contextPath);
      out.write("/list.ex?currentPage=1\">전시 목록</a> <a\r\n");
      ...
      out.print(contextPath);
      out.write("/list.no\">공지사항</a> <a\r\n");
      out.write("					class=\"collapse-item\" href=\"");
      out.print(contextPath);
      out.write("/list.ne\">뉴스레터</a> <a\r\n");
      out.write("					class=\"collapse-item\" href=\"");
      out.print(contextPath);
      out.write("/list.qna\">1대1문의</a> <a\r\n");
      out.write("					class=\"collapse-item\" href=\"");
      out.print(contextPath);
      out.write("/list.re?currentPage=1\">리뷰</a>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div></li>\r\n");
      out.write("\r\n");
...
session.removeAttribute("alertMsg");
      ...
      out.write("							<div>₩ 500000</div>\r\n");
      out.write("						</div>\r\n");
      out.write("						<div class=\"sales\">\r\n");
      out.write("							<div>WEEKS</div>\r\n");
      out.write("							<div>₩ 123120123</div>\r\n");
      out.write("						</div>\r\n");
      out.write("					</div>\r\n");
      out.write("\r\n");
      ...
      out.write("					<!-- 차트 js영역 -->\r\n");
      out.write("					<script>\r\n");
      out.write("						let today_sales = '';\r\n");
      out.write("						let week_sales = '';\r\n");
      out.write("						let month_sales = '';\r\n");
      out.write("						$(() => {\r\n");
      out.write("							console.log();\r\n");
      out.write("							selectSalesData();\r\n");
      out.write("							selectGenderData();\r\n");
      out.write("						})\r\n");
      out.write("						function selectSalesData(){\r\n");
      out.write("							$.ajax({\r\n");
      out.write("								url : '");
      out.print(contextPath);
      out.write("/salesData.st',\r\n");
      out.write("								data : {},\r\n");
      out.write("								type : 'get',\r\n");
      out.write("								success : ((res) => {\r\n");
      out.write("									today_sales = res.today\r\n");
      out.write("									week_sales = res.week\r\n");
      out.write("									month_sales = res.month\r\n");
      out.write("								}),\r\n");
      out.write("								error : () => console.log('매출 통계 데이터 AJAX 통신 중 에러 발생')\r\n");
      out.write("							})\r\n");
      out.write("						}\r\n");
      out.write("\r\n");
      out.write("						function selectGenderData() {\r\n");
      out.write("							$.ajax({\r\n");
      out.write("								url : '");
      out.print(contextPath);
      out.write("/genderData.st',\r\n");
      out.write("								data : {},\r\n");
      out.write("								type : 'get',\r\n");
      out.write("								success : (res) => {\r\n");
      out.write("\r\n");
      out.write("								},\r\n");
      out.write("								error : () => console.log('성별별 통계 데이터 AJAX 통신 중 에러 발생')\r\n");
      out.write("							})\r\n");
      out.write("						}\r\n");
      out.write("						var perMonth = new Chart(document.getElementById('perMonth').getContext('2d'),{\r\n");
      out.write("							type: 'line', // 차트의 형태\r\n");
      out.write("							data: { // 차트에 들어갈 데이터\r\n");
      out.write("										// x축\r\n");
      out.write("								labels: ['7월', '8월', '9월', '10월', '11월', '12월'],\r\n");
      out.write("								datasets: [{ //데이터\r\n");
      out.write("												label: '월간 매출 추이', //차트 제목\r\n");
      out.write("												fill: false, // line 형태일 때, 선 안쪽을 채우는지 안채우는지\r\n");
      out.write("												data: [123123, 1200000, 3300000,\r\n");
      out.write("													5500000, 5200000, 7000000, 12000000 //x축 label에 대응되는 데이터 값\r\n");
      out.write("												],\r\n");
      ...
      out.write("										}\r\n");
      out.write("									});\r\n");
      out.write("									var gender = new Chart(document.getElementById('gender')\r\n");
      out.write("										.getContext('2d'), {\r\n");
      out.write("										type: 'doughnut', // 차트의 형태\r\n");
      out.write("										data: { // 차트에 들어갈 데이터\r\n");
      out.write("											labels: [\r\n");
      out.write("												//x 축\r\n");
      out.write("												'20대 남성', '20대 여성', '30대 남성', '30대 여성'],\r\n");
      out.write("											datasets: [{ //데이터\r\n");
      out.write("												label: '성별별 예매율', //차트 제목\r\n");
      out.write("												fill: false, // line 형태일 때, 선 안쪽을 채우는지 안채우는지\r\n");
      out.write("												data: [10, 30, 20, 40 //x축 label에 대응되는 데이터 값\r\n");
      out.write("												],\r\n");
      out.write("												backgroundColor: [\r\n");
      out.write("													//색상\r\n");
      out.write("													'rgba(255, 99, 132, 0.2)',\r\n");
      ...
      out.write("									<td>31</td>\r\n");
      out.write("									<td>결제</td>\r\n");
      out.write("									<td class=\"qnaTitle\">할인해주세요</td>\r\n");
      out.write("									<td>진상1</td>\r\n");
      ...
      out.write("									<td>22</td>\r\n");
      out.write("									<td>기타</td>\r\n");
      out.write("									<td class=\"qnaTitle\">직원분 맘에들어서그러는데 연락처좀알려주세요</td>\r\n");
      out.write("									<td>진상2</td>\r\n");
      out.write("									<td>2022-10-13</td>\r\n");
      out.write("								</tr>\r\n");
      out.write("								<tr>\r\n");
      out.write("									<td>15</td>\r\n");
      out.write("									<td>전시</td>\r\n");
      out.write("									<td class=\"qnaTitle\">제가해도이거보다잘할거같은데</td>\r\n");
      out.write("									<td>진상3</td>\r\n");
      ...
      out.write("\r\n");
      out.write("					<script>\r\n");
      out.write("									const qnaTitles = document.querySelectorAll('.qnaTitle');\r\n");
      out.write("\r\n");
      out.write("									qnaTitles.forEach(item => {\r\n");
      out.write("										item.addEventListener('click', onClickHandler);\r\n");
      out.write("									})\r\n");
      out.write("\r\n");
      out.write("									function onClickHandler(event) {\r\n");
      out.write("										// 글제목 클릭한놈 이전의 이전 형제 == 글 번호(숫자) 선택\r\n");
      out.write("										const qno = event.currentTarget.previousElementSibling.previousElementSibling.textContent;\r\n");
      out.write("										// 제이쿼리 못써서 지저분함니다 정리가능하신분 정리바람의나라\r\n");
      out.write("\r\n");
      out.write("										location.href=\"/jv/detail.qna?qno=\"+qno;\r\n");
      out.write("									}\r\n");
      out.write("					</script>\r\n");
      out.write("				</div>\r\n");
      out.write("\r\n");
