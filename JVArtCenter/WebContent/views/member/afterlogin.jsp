            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarColor03">
                <ul class="navbar-nav me-auto" id="navbar_menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="views/reservation/ReservationStep1View.jsp">예매</a>
                  </li>
                  <li class="nav-item">
              ...
              <div id="navbar_icons">
                ...
                <a href=""><i id="calender" class="fa-regular fa-calendar-days"></i></a>
                <!-- 로그인 성공후마이페이지로 이동 -->
				<a href="views/member/mypage.jsp"><i id="user" class="fa-regular fa-user"></i></a>
				<a href="/jv"><i class="fa-solid fa-arrow-right-from-bracket"></i></a>
              </div>
