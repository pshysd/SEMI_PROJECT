				...
				<div id="admin_contents">
					<form id="update-form" action="<%=contextPath%>/update.mb"
						...
						<table align="center" border="1px solid black">
							<tr>
								<td>이름</td>
								<td><input type="text" name="memName" id=""
									value="<%=m.getMemName()%>"></td>
								<td>등급</td>
								<td><input type="radio" name="grade" id="common" value="일반"><label for="common"> 일반 </label> 
									<input type="radio" name="grade" id="vip" value="vip"><label for="vip"> VIP </label> 
									<input type="radio" name="grade" id="vvip" value="vvip"><label for="vvip">VVIP </label></td>
							</tr>
							<tr>
								<td>성별</td>
								<td><input type="radio" name="gender" id="M"><label
									for="M">남성</label><input type="radio" name="gender" id="F"><label
									for="F">여성</label></td>
								<td>연락처</td>
								<td><input type="text" name="phone" id=""
									value="<%=m.getPhone()%>" required></td>
							</tr>
							<tr>
								<td>아이디</td>
							...
							<tr>
								...
								<td>탈퇴여부</td>
								<td><input type="radio" name="status" id="Y"><label for="Y">탈퇴</label>
								<input type="radio" name="status" id="N"><label for="N">가입</label></td>
							</tr>
						</table>
						<br>
						<div align="center">
